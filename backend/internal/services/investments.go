...
func (s InvestmentService) ImportIIFLSecuritiesHoldingsCSV(ctx context.Context, input ImportInvestmentPricesInput) (InvestmentPriceImportResult, error) {
	if strings.TrimSpace(input.Source) == "" {
		input.Source = "iiflsecurities_holdings_csv"
	}
	return s.ImportBrokerHoldingsCSV(ctx, input)
}

func (s InvestmentService) ImportFYERSHoldingsCSV(ctx context.Context, input ImportInvestmentPricesInput) (InvestmentPriceImportResult, error) {
	if strings.TrimSpace(input.Source) == "" {
		input.Source = "fyers_holdings_csv"
	}
	return s.ImportBrokerHoldingsCSV(ctx, input)
}

func (s InvestmentService) ImportEdelweissHoldingsCSV(ctx context.Context, input ImportInvestmentPricesInput) (InvestmentPriceImportResult, error) {
	if strings.TrimSpace(input.Source) == "" {
		input.Source = "edelweiss_holdings_csv"
	}
	return s.ImportBrokerHoldingsCSV(ctx, input)
}

func (s InvestmentService) ImportAliceBlueHoldingsCSV(ctx context.Context, input ImportInvestmentPricesInput) (InvestmentPriceImportResult, error) {
	if strings.TrimSpace(input.Source) == "" {
		input.Source = "aliceblue_holdings_csv"
	}
	return s.ImportBrokerHoldingsCSV(ctx, input)
}

func (s InvestmentService) ImportSamcoHoldingsCSV(ctx context.Context, input ImportInvestmentPricesInput) (InvestmentPriceImportResult, error) {
	if strings.TrimSpace(input.Source) == "" {
		input.Source = "samco_holdings_csv"
	}
	return s.ImportBrokerHoldingsCSV(ctx, input)
}

func (s InvestmentService) ImportChoiceHoldingsCSV(ctx context.Context, input ImportInvestmentPricesInput) (InvestmentPriceImportResult, error) {
	if strings.TrimSpace(input.Source) == "" {
		input.Source = "choice_holdings_csv"
	}
	return s.ImportBrokerHoldingsCSV(ctx, input)
}

func (s InvestmentService) ImportReligareHoldingsCSV(ctx context.Context, input ImportInvestmentPricesInput) (InvestmentPriceImportResult, error) {
	if strings.TrimSpace(input.Source) == "" {
		input.Source = "religare_holdings_csv"
	}
	return s.ImportBrokerHoldingsCSV(ctx, input)
}

func (s InvestmentService) ImportJainamHoldingsCSV(ctx context.Context, input ImportInvestmentPricesInput) (InvestmentPriceImportResult, error) {
	if strings.TrimSpace(input.Source) == "" {
		input.Source = "jainam_holdings_csv"
	}
	return s.ImportBrokerHoldingsCSV(ctx, input)
}
