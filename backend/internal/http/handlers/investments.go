...
func (h InvestmentHandler) RegisterWriteRoutes(router gin.IRoutes) {
	...
	router.POST("/investments/prices/import/groww-holdings", h.ImportGrowwHoldingsCSV)
	router.POST("/investments/prices/import/upstox-holdings", h.ImportUpstoxHoldingsCSV)
	router.POST("/investments/prices/import/angelone-holdings", h.ImportAngelOneHoldingsCSV)
	router.POST("/investments/prices/import/dhan-holdings", h.ImportDhanHoldingsCSV)
	router.POST("/investments/prices/import/icicidirect-holdings", h.ImportICICIDirectHoldingsCSV)
	router.POST("/investments/prices/import/hdfcsky-holdings", h.ImportHDFCSkyHoldingsCSV)
	router.POST("/investments/prices/import/kotakneo-holdings", h.ImportKotakNeoHoldingsCSV)
	router.POST("/investments/prices/import/paytmmoney-holdings", h.ImportPaytmMoneyHoldingsCSV)
	router.POST("/investments/prices/import/motilaloswal-holdings", h.ImportMotilalOswalHoldingsCSV)
	router.POST("/investments/prices/import/sharekhan-holdings", h.ImportSharekhanHoldingsCSV)
	router.POST("/investments/prices/import/fivepaisa-holdings", h.ImportFivePaisaHoldingsCSV)
	...
	router.POST("/investments/prices/import/iiflsecurities-holdings", h.ImportIIFLSecuritiesHoldingsCSV)
	...
	router.POST("/investments/prices/import/choice-holdings", h.ImportChoiceHoldingsCSV)
	router.POST("/investments/prices/import/religare-holdings", h.ImportReligareHoldingsCSV)
	router.POST("/investments/prices/import/jainam-holdings", h.ImportJainamHoldingsCSV)
...
func (h InvestmentHandler) ImportGrowwHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportGrowwHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportUpstoxHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportUpstoxHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportAngelOneHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportAngelOneHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportDhanHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportDhanHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportICICIDirectHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportICICIDirectHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportHDFCSkyHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportHDFCSkyHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportKotakNeoHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportKotakNeoHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportPaytmMoneyHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportPaytmMoneyHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportMotilalOswalHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportMotilalOswalHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportSharekhanHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportSharekhanHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportFivePaisaHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportFivePaisaHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportAxisDirectHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportAxisDirectHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportSBISecuritiesHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportSBISecuritiesHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportNuvamaHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
...
func (h InvestmentHandler) ImportIIFLSecuritiesHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportIIFLSecuritiesHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportFYERSHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportFYERSHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportEdelweissHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportEdelweissHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportAliceBlueHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
...
func (h InvestmentHandler) ImportChoiceHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportChoiceHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportReligareHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportReligareHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
...
func (h InvestmentHandler) ImportJainamHoldingsCSV(c *gin.Context) {
	var request importInvestmentPricesRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		respondError(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	...
	result, err := h.investments.ImportJainamHoldingsCSV(c.Request.Context(), services.ImportInvestmentPricesInput{
		OrganizationID: c.Param("organizationId"),
		CSV:            request.CSV,
		Source:         request.Source,
	})
