...
- Attachment metadata, local binary upload/download with configurable size limits and SHA-256 checksum metadata, organization JSON export, local backup snapshots with optional checksum-verified mirror copies.
