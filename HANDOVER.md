...
Current API coverage: `139` OpenAPI route/method pairs, matched to Gin handlers and Postman.
...
6. Export/reporting polish: Excel exports plus richer report drilldowns.
