...
- Added expanded core report PDF exports for cash flow, AR/AP aging, tax liability, and tax summary, keeping OpenAPI/Postman coverage aligned at 139 documented route/method pairs.
...
- Reports: trial balance, P&L, balance sheet, cash flow, AR/AP aging, tax reports, budget vs actual, realized gains, investment dividends, investment tax lots, investment valuation, expanded core report PDF exports, and managed scheduled report snapshots with optional SMTP delivery for core financial reports.
...
- Export/reporting polish: expanded core report PDFs, scheduled report SMTP delivery, Flutter statement/aging/tax prior-period comparison, selected-vs-previous budget comparison, and Flutter cached-report CSV generation with app-storage/Downloads/share-sheet support are implemented; Excel exports and richer report drilldowns remain.
- UI polish: complete CRUD flows, validation UX, module dashboards, broader mobile/desktop Flutter parity.

## Suggested Next Build Order
1. Excel exports and richer report drilldowns.
