...
Current API coverage is 155 documented route/method pairs, validated against Gin handlers and the Postman collection in CI.
...
- `Investments`: Lots, disposals, average-cost sales, dividends, corporate actions, tax lots, tax-adjustment candidates, prices, CSV/AMFI/NSE/BSE/Yahoo/Alpha Vantage imports, valuation, and CSV report exports.
