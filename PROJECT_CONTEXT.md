...
- Initial offline write replay supports expense drafts, invoice drafts, attachment metadata, and manual investment prices; next workflows should prioritize payments, status transitions, import drafts, and binary attachment upload replay.
- Platform features:
