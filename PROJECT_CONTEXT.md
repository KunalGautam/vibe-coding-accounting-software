...
- Initial offline write replay supports expense drafts, invoice drafts, customer payments, vendor payments, attachment metadata, binary attachment uploads, and manual investment prices; next workflows should prioritize edits, status transitions, import drafts, and native SQLite persistence.
- Platform features:
