...
- Local SQLite cache for Flutter is now active for the pending sync-operation queue, account cache, tax catalog cache, and queued-attachment upload manifest; remaining invoice/investment/attachment read caches, settings, and binary cache still use file-backed repositories until migration lands.
