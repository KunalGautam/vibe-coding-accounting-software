...
- Reporting engine for Balance Sheet, P&L, Trial Balance, Cash Flow, AR/AP Aging, Tax Liability, and Tax Summary: Initial reports complete, with account-level ledger drilldown plus PDF and Excel-compatible CSV exports for trial balance, P&L, balance sheet, cash flow, AR/AP aging, tax liability, and tax summary.
