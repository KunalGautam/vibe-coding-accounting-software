...
void main() {
  ...
  test('syncs queued SBI Securities holdings price imports', () async {
    final queue = OfflineSyncQueue([
      SyncOperation(
        id: 'sbisecurities-holdings-import-local-1',
        module: 'investments',
        action: 'import_broker_holdings',
        createdAt: DateTime.utc(2026, 7, 15),
        payload: const {
  ...
  test('syncs queued Nuvama holdings price imports', () async {
    final queue = OfflineSyncQueue([
      SyncOperation(
        id: 'nuvama-holdings-import-local-1',
        module: 'investments',
        action: 'import_broker_holdings',
        createdAt: DateTime.utc(2026, 7, 15),
        payload: const {
  ...
  test('syncs queued Geojit holdings price imports', () async {
    final queue = OfflineSyncQueue([
      SyncOperation(
        id: 'geojit-holdings-import-local-1',
        module: 'investments',
        action: 'import_broker_holdings',
        createdAt: DateTime.utc(2026, 7, 15),
        payload: const {
  ...
  test('syncs queued FYERS holdings price imports', () async {
    final queue = OfflineSyncQueue([
      SyncOperation(
        id: 'fyers-holdings-import-local-1',
        module: 'investments',
        action: 'import_broker_holdings',
        createdAt: DateTime.utc(2026, 7, 15),
        payload: const {
  ...
  test('syncs queued Edelweiss holdings price imports', () async {
    final queue = OfflineSyncQueue([
      SyncOperation(
        id: 'edelweiss-holdings-import-local-1',
        module: 'investments',
        action: 'import_broker_holdings',
        createdAt: DateTime.utc(2026, 7, 15),
        payload: const {
  ...
  test('syncs queued Alice Blue holdings price imports', () async {
    final queue = OfflineSyncQueue([
      SyncOperation(
        id: 'aliceblue-holdings-import-local-1',
        module: 'investments',
        action: 'import_broker_holdings',
        createdAt: DateTime.utc(2026, 7, 15),
        payload: const {
  ...
  test('syncs queued Samco holdings price imports', () async {
    final queue = OfflineSyncQueue([
      SyncOperation(
        id: 'samco-holdings-import-local-1',
        module: 'investments',
        action: 'import_broker_holdings',
        createdAt: DateTime.utc(2026, 7, 15),
        payload: const {
  ...
  test('syncs queued Religare holdings price imports', () async {
    final queue = OfflineSyncQueue([
      SyncOperation(
        id: 'religare-holdings-import-local-1',
        module: 'investments',
        action: 'import_broker_holdings',
        createdAt: DateTime.utc(2026, 7, 15),
        payload: const {
