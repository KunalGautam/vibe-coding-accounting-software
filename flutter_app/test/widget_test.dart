...
void main() {
  ...
  testWidgets('queues Zerodha holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.pumpAndSettle();
    await tester.tap(find.text('Zerodha holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'zerodha_holdings_csv');
    expect(pending.last.payload['csv'], contains('Instrument'));
  });

  testWidgets('queues Groww holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Groww holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'groww_holdings_csv');
    expect(pending.last.payload['csv'], contains('Company Name'));
  });

  testWidgets('queues Upstox holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Upstox holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'upstox_holdings_csv');
    expect(pending.last.payload['csv'], contains('Current Price'));
  });

  testWidgets('queues Angel One holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Angel One holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'angelone_holdings_csv');
    expect(pending.last.payload['csv'], contains('Scrip'));
  });

  testWidgets('queues Dhan holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Dhan holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'dhan_holdings_csv');
  ...
  testWidgets('queues HDFC Sky holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('HDFC Sky holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'hdfcsky_holdings_csv');
    expect(pending.last.payload['csv'], contains('MARUTI'));
  });

  testWidgets('queues Kotak Neo holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Kotak Neo holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'kotakneo_holdings_csv');
    expect(pending.last.payload['csv'], contains('BAJFINANCE'));
  });

  testWidgets('queues Paytm Money holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Paytm Money holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'paytmmoney_holdings_csv');
    expect(pending.last.payload['csv'], contains('TATAMOTORS'));
  });

  testWidgets(
    'queues Motilal Oswal holdings imports from the investments page',
    (tester) async {
      useTallTestViewport(tester);
      final syncRepository = MemorySyncOperationRepository();
      ...
      await tester.tap(find.text('Generic broker holdings CSV'));
      await tester.pumpAndSettle();
      await tester.tap(find.text('Motilal Oswal holdings CSV').last);
      await tester.pumpAndSettle();
      await tester.ensureVisible(find.text('Queue broker holdings import'));
      await tester.tap(find.text('Queue broker holdings import'));
      await tester.pumpAndSettle();
      ...
      expect(pending.last.module, 'investments');
      expect(pending.last.action, 'import_broker_holdings');
      expect(pending.last.payload['source'], 'motilaloswal_holdings_csv');
      expect(pending.last.payload['csv'], contains('ASIANPAINT'));
    },
  );

  testWidgets('queues Sharekhan holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Sharekhan holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'sharekhan_holdings_csv');
    expect(pending.last.payload['csv'], contains('HINDUNILVR'));
  });

  testWidgets('queues 5paisa holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('5paisa holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'fivepaisa_holdings_csv');
    expect(pending.last.payload['csv'], contains('SBIN'));
  });

  testWidgets('queues Axis Direct holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Axis Direct holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'axisdirect_holdings_csv');
  ...
  testWidgets('queues Nuvama holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Nuvama holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'nuvama_holdings_csv');
    expect(pending.last.payload['csv'], contains('WIPRO'));
  });

  testWidgets('queues Geojit holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Geojit holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'geojit_holdings_csv');
    expect(pending.last.payload['csv'], contains('HCLTECH'));
  });

  testWidgets(
    'queues IIFL Securities holdings imports from the investments page',
    (tester) async {
      useTallTestViewport(tester);
      final syncRepository = MemorySyncOperationRepository();
      ...
      await tester.tap(find.text('Generic broker holdings CSV'));
      await tester.pumpAndSettle();
      await tester.tap(find.text('IIFL Securities holdings CSV').last);
      await tester.pumpAndSettle();
      await tester.ensureVisible(find.text('Queue broker holdings import'));
      await tester.tap(find.text('Queue broker holdings import'));
      await tester.pumpAndSettle();
      ...
      expect(pending.last.module, 'investments');
      expect(pending.last.action, 'import_broker_holdings');
      expect(pending.last.payload['source'], 'iiflsecurities_holdings_csv');
      expect(pending.last.payload['csv'], contains('TITAN'));
    },
  );
  ...
  testWidgets('queues Edelweiss holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Edelweiss holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'edelweiss_holdings_csv');
    expect(pending.last.payload['csv'], contains('EDELWEISS'));
  });

  testWidgets('queues Alice Blue holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Alice Blue holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'aliceblue_holdings_csv');
    expect(pending.last.payload['csv'], contains('TCS'));
  });

  testWidgets('queues Samco holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Samco holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'samco_holdings_csv');
    expect(pending.last.payload['csv'], contains('SUNPHARMA'));
  });

  testWidgets('queues Choice holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Choice holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'choice_holdings_csv');
    expect(pending.last.payload['csv'], contains('ULTRACEMCO'));
  });

  testWidgets('queues Religare holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Religare holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'religare_holdings_csv');
    expect(pending.last.payload['csv'], contains('ADANIPORTS'));
  });

  testWidgets('queues Jainam holdings imports from the investments page', (
    tester,
  ) async {
    useTallTestViewport(tester);
    final syncRepository = MemorySyncOperationRepository();
    ...
    await tester.tap(find.text('Generic broker holdings CSV'));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Jainam holdings CSV').last);
    await tester.pumpAndSettle();
    await tester.ensureVisible(find.text('Queue broker holdings import'));
    await tester.tap(find.text('Queue broker holdings import'));
    await tester.pumpAndSettle();
    ...
    expect(pending.last.module, 'investments');
    expect(pending.last.action, 'import_broker_holdings');
    expect(pending.last.payload['source'], 'jainam_holdings_csv');
    expect(pending.last.payload['csv'], contains('POWERGRID'));
  });
