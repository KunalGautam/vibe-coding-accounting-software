...
- Typed investment transport for lot creation, dividend capture, corporate actions, average-cost pooled sales, price maintenance, broker holdings/Zerodha holdings price imports, realized gains, and valuation reports.
...
- Offline replay for broker holdings and Zerodha holdings price imports through the `investments.import_broker_holdings` sync operation.
- Investments page includes broker/Zerodha holdings CSV paste and file-pick flows that queue imports for later sync.
