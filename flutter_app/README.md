...
- Reports page with Trial Balance, P&L, Balance Sheet, Cash Flow, AR Aging, AP Aging, Tax Liability, and Tax Summary API refresh plus SQLite-backed offline report snapshot review.
