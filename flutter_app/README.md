...
- Reports page with Trial Balance, P&L, Balance Sheet, Cash Flow, AR Aging, AP Aging, Tax Liability, Tax Summary, and Budget vs Actual API refresh plus SQLite-backed offline report snapshot review and generated CSV export payload previews.
